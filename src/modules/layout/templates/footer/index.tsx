...
export default async function Footer() {
  ...
  return (
    <footer className="border-t border-ui-border-base w-full  bg-[#ffb703]  text-[#023047] ">
      <div className="content-container flex flex-col w-full">
          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3">
            ...
            {collections && collections.length > 0 && (
              <div className="flex flex-col gap-y-2">
                ...
                <ul
                  className={clx(
                    "grid grid-cols-1 gap-2  text-[#023047]  txt-small",
                    {
            ...
            <div className="flex flex-col gap-y-2">
              <span className="txt-small-plus txt-ui-fg-base">CharanDhull</span>
        ...
        <div className="flex w-full mb-16 justify-between text-[#023047]  ">
          <Text className="txt-compact-small ">
            © {new Date().getFullYear()} Charan Dhull Store. All rights
            reserved.
          </Text>
          {/* <MedusaCTA /> */}
        </div>
