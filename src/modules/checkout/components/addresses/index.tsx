          ...
          <div className="text-small-regular">
            {cart && cart.shipping_address ? (
              <div className="flex items-start gap-x-8">
                {/* <div className="flex md:flex-row flex-col  items-start gap-x-1 w-full">
                  <div className="flex flex-col w-1/3" data-testid="shipping-address-summary">
                    <Text className="txt-medium-plus text-ui-fg-base mb-1">
                      Shipping Address
                    </Text>
                    <Text className="txt-medium text-ui-fg-subtle flex-row">
                ...
                <div className="flex flex-col md:flex-row items-start gap-x-4 w-full">
                  <div
                    className="flex flex-col w-full md:w-1/3 mb-4 md:mb-0"
