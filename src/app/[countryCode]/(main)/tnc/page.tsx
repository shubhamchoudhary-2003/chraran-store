...
const TermsAndConditions = () => {
  return (
    <div className=" text-black  font-cabin  p-8">
      <header className="flex  align-middle  mb-8">
        <img src={logo.src} alt="Charandhul Logo" className="h-24 mr-5" />
        {/* <h1 className="text-[#7f5539] text-4xl">Charandhul</h1> */}
      </header>
      <section className="   border border-[#023047] p-5 mb-5">
        <h2 className="text-3xl font-semibold mb-4">TERMS & CONDITIONS</h2>
        <h3 className="text-2xl font-semibold mb-3">OVERVIEW</h3>
        <p className="mb-4">
          This website is operated by Charandhul. Throughout the site, the terms
          “we”, “us” and “our” refer to Charandhul. Charandhul offers this
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          ...
          POLICY]. We have made every effort to display as accurately as
          possible the colors and images of our products that appear at the
          store. We cannot guarantee that your computer monitor&lsquos display
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          ...
          third-party&lsquos policies and practices and make sure you understand
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          ...
          &lsquocomments&lsquo), you agree that we may, at any time, without
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          ...
          by our Privacy Policy. To view our Privacy Policy, please see [LINK TO
          PRIVACY POLICY].
        </p>
      </section>
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          ...
          service are (except as expressly stated by us) provided &lsquoas
          is&lsquo and &lsquoas available&lsquo for your use, without any
          ...
          Charandhul, our directors, officers, employees, affiliates, agents,
      ...
      <section className="   border border-[#023047]  p-5 mb-5">
        ...
        <p className="mb-4">
          You agree to indemnify, defend and hold harmless Charandhul and our
